...
// => 4
//
const numberOfValues = (rowOrCol, value) => {
  return rowOrCol
    .filter(v => v === value)
    .length
}
...
const areIdentical = (rowOrCol1, rowOrCol2) => {
...
const removeRandomValuesFromBoard = (board, goalPercentage = 25) => {
...
const playerProgress = (board, locked) => {
